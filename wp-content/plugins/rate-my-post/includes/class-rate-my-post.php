...
class Rate_My_Post {
	...
	private function define_admin_hooks() {
		...
		//SUBMENU STATS SECTION
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'submenu_stats_section' );
		//SUBMENU ANALYTICS SECTION
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'submenu_analytics_section' );
		//OPTIONS UPDATE AJAX

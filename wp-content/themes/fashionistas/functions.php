...
function athemes_setup() {
	 ...
	 * to change 'fashionistas' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'fashionistas', get_template_directory() . '/lang' );
	...
	register_nav_menus( array(
		'top' => __( 'Top Menu', 'fashionistas' ),
		'main' => __( 'Main Menu', 'fashionistas' ),
	) );
...
function athemes_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Sub Footer 1', 'fashionistas' ),
		'id'            => 'sidebar-3',
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Sub Footer 2', 'fashionistas' ),
		'id'            => 'sidebar-4',
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Sub Footer 3', 'fashionistas' ),
		'id'            => 'sidebar-5',
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Sub Footer 4', 'fashionistas' ),
		'id'            => 'sidebar-6',
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title">',
...
function athemes_footer_credits() {
	?>
	<div class="site-info">
		&copy; <?php echo date('Y'); ?> <?php bloginfo( 'name' ); ?><?php esc_html_e('. All rights reserved.', 'fashionistas'); ?>
	</div><!-- .site-info -->

	<div class="site-credit">
		<a href="https://athemes.com/theme/fashionista" rel="nofollow">WRITTING</a><?php esc_html_e(' by Galdames', 'fashionistas'); ?>
	</div><!-- .site-credit -->
	<?php
}

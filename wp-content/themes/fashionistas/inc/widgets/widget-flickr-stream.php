 ...
 */
function fashionistas_register_athemes_flickr_stream() {
	register_widget( "athemes_flickr_stream" );
}
add_action( 'widgets_init', 'fashionistas_register_athemes_flickr_stream' );
...
class aThemes_Flickr_Stream extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'AT Flickr Stream',
			array(
				'description'	=> __( 'Displays your Flickr photos.', 'fashionistas' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'flickr_id' => array (
				...
				'athemes_widgets_title'			=> __( 'Flickr ID', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'photo_count' => array (
				'athemes_widgets_name'			=> 'photo_count',
				'athemes_widgets_title'			=> __( 'Number of Photos', 'fashionistas' ),
			...
			'photo_type' => array (
				...
				'athemes_widgets_title'			=> __( 'Type (user or group)', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'select',
				'athemes_widgets_field_options'	=> array(
					'user' 		=> 'User',
					'group' 	=> 'Group'
			...
			'photo_display' => array (
				...
				'athemes_widgets_title'			=> __( 'Display', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'select',
				'athemes_widgets_field_options'	=> array(
					'latest'	=> 'Latest',
					'random' 	=> 'Random'

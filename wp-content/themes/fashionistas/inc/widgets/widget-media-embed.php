...
function fashionistas_register_athemes_media_embed() {
	register_widget( "athemes_media_embed" );
}
add_action( 'widgets_init', 'fashionistas_register_athemes_media_embed' );
...
class aThemes_Media_Embed extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'AT Media Embed',
			array(
				'description'	=> __( 'Display media (video/slideshow) widget, support many sites including YouTube, Vimeo, Flickr, etc.', 'fashionistas' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'embed_url' => array (
				...
				'athemes_widgets_title'			=> __( 'Embed URL', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'embed_width' => array (
				'athemes_widgets_name'			=> 'embed_width',
				'athemes_widgets_title'			=> __( 'Embed width in pixels', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'number'
			),
			'embed_description' => array (
				'athemes_widgets_name'			=> 'embed_description',
				'athemes_widgets_title'			=> __( 'Description', 'fashionistas' ),

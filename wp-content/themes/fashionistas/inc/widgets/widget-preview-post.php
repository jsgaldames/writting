...
function fashionistas_register_athemes_preview_post() {
	register_widget( "athemes_preview_post" );
}
add_action( 'widgets_init', 'fashionistas_register_athemes_preview_post' );
class aThemes_Preview_Post extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'AT Preview Post',
			array(
				'description'	=> __( 'A widget that shows post/page preview', 'fashionistas' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'post_id' => array (
				...
				'athemes_widgets_title'			=> __( 'Post ID', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'number'
			),
			'display_title' => array (
				'athemes_widgets_name'			=> 'display_title',
				'athemes_widgets_title'			=> __( 'Show post title', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'checkbox'
			),
			'display_thumbnail' => array (
				'athemes_widgets_name'			=> 'display_thumbnail',
				'athemes_widgets_title'			=> __( 'Show featured image', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'checkbox'
			),
			'display_excerpt' => array (
				'athemes_widgets_name'			=> 'display_excerpt',
				'athemes_widgets_title'			=> __( 'Show excerpt', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'checkbox'
			),
			'read_more_text' => array (
				'athemes_widgets_name'			=> 'read_more_text',
				'athemes_widgets_title'			=> __( 'Read more link text', 'fashionistas' ),
				'athemes_widgets_description'	=> __( 'Leave empty for no link', 'fashionistas' ),

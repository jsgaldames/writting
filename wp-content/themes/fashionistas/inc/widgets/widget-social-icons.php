...
function fashionistas_register_athemes_social_icons() {
	register_widget( "athemes_social_icons" );
}
add_action( 'widgets_init', 'fashionistas_register_athemes_social_icons' );
...
class aThemes_Social_Icons extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'AT Social Icons',
			array(
				'description'	=> __( 'Display links to your social network profiles, enter full profile URLs', 'fashionistas' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'widget_title' => array(
				...
				'athemes_widgets_title'			=> __( 'Title', 'fashionistas' ),
			...
			'twitter' => array (
				...
				'athemes_widgets_title'			=> __( 'Twitter', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'facebook' => array (
				'athemes_widgets_name'			=> 'facebook',
				'athemes_widgets_title'			=> __( 'Facebook', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'linkedin' => array (
				'athemes_widgets_name'			=> 'linkedin',
				'athemes_widgets_title'			=> __( 'LinkedIn', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'gplus' => array (
				'athemes_widgets_name'			=> 'gplus',
				'athemes_widgets_title'			=> __( 'Google+', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'pinterest' => array (
				'athemes_widgets_name'			=> 'pinterest',
				'athemes_widgets_title'			=> __( 'Pinterest', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'youtube' => array (
				'athemes_widgets_name'			=> 'youtube',
				'athemes_widgets_title'			=> __( 'YouTube', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'vimeo' => array (
				'athemes_widgets_name'			=> 'vimeo',
				'athemes_widgets_title'			=> __( 'Vimeo', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'flickr' => array (
				'athemes_widgets_name'			=> 'flickr',
				'athemes_widgets_title'			=> __( 'Flickr', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'dribbble' => array (
				'athemes_widgets_name'			=> 'dribbble',
				'athemes_widgets_title'			=> __( 'Dribbble', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'tumblr' => array (
				'athemes_widgets_name'			=> 'tumblr',
				'athemes_widgets_title'			=> __( 'Tumblr', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'instagram' => array (
				'athemes_widgets_name'			=> 'instagram',
				'athemes_widgets_title'			=> __( 'Instagram', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'lastfm' => array (
				'athemes_widgets_name'			=> 'lastfm',
				'athemes_widgets_title'			=> __( 'Last.fm', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'soundcloud' => array (
				'athemes_widgets_name'			=> 'soundcloud',
				'athemes_widgets_title'			=> __( 'SoundCloud', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
		);

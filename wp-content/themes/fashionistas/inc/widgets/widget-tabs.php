...
function fashionistas_register_athemes_tabs() {
	register_widget( "athemes_tabs" );
}
add_action( 'widgets_init', 'fashionistas_register_athemes_tabs' );
...
class aThemes_Tabs extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'AT Tabs',
			array(
				'description'	=> __( 'Display a tabbed content widget for your popular posts, recent posts and popular tags.', 'fashionistas' )
			)
		);
	}
	 ...
	 private function widget_fields() {
		$fields = array(
			...
			'tabs_post_count' => array (
				...
				'athemes_widgets_title'			=> __( 'Posts to Show', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
			'tabs_tag_count' => array (
				'athemes_widgets_name'				=> 'tabs_tag_count',
				'athemes_widgets_title'			=> __( 'Tags to Show', 'fashionistas' ),
				'athemes_widgets_field_type'		=> 'text'
			),
		);
	...
	public function widget( $args, $instance ) {
		...
		<ul id="widget-tab" class="clearfix widget-tab-nav">
			<li class="active"><a href="#widget-tab-popular"><?php _e( 'Popular', 'fashionistas' ); ?></a></li>
			<li><a href="#widget-tab-latest"><?php _e('Latest', 'fashionistas' ); ?></a></li>
			<li><a href="#widget-tab-tags"><?php _e( 'Tags', 'fashionistas' ); ?></a></li>
		</ul>
				...
				<?php $popular = new WP_Query('orderby=comment_count&ignore_sticky_posts=1&posts_per_page=' . $tabs_post_count );
					...
					<li class="clearfix">
						...
						<div class="widget-entry-summary">
							...
							<span><?php comments_number( __( 'No Comments', 'fashionistas' ), __( '1 Comment', 'fashionistas' ), __( '% Comments', 'fashionistas' ) ); ?></span>
						</div>
						<?php } else { ?>
